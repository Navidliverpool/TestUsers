...
namespace TestUsers.Models
{
    public partial class ShoppingCart3
    {
        ...
        public static ShoppingCart3 GetCart(HttpContextBase context)
        {
            var cart = new ShoppingCart3();
            cart.ShoppingCartId = cart.GetCartId(context);
            return cart;
        }

        // Helper method to simplify shopping cart calls
        public static ShoppingCart3 GetCart(Controller controller)
        {
...
&& cart.RecordId == id);
        ...
        public int CreateOrder(Order order)
        {
            ...
            foreach (var item in cartItems)
            {
                ...
                orderTotal = orderTotal + (decimal)(item.Count * item.Motorcycle.Price);
